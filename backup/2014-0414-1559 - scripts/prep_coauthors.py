...
# usage: prep_coauthors.py -i DIR -o DIR [-d INT] [-v]
# 
...
## ##################################################
## ##################################################
def prep_coA(in_dir,out_dir,dyn_window,verbose):
...
def confirm_threshold(vA,lA,yyA,nb_art):
...
#   -r 
  ...
  prep_coA(args.in_dir[0],args.out_dir[0],args.dyn_window[0],args.verbose)
